...
public class BluetoothService extends Service {
    public static final String tag = "debuggingBTS";

    public BluetoothTrafficLightConnectThread tlConnect;
    public BluetoothBikeConnectThread connect;

    public static SmartRideConnectedThread connectedThread;
    public TrafficLightEmulatorConnectedThread connectedTrafficLightThread;
    ...
    protected static final int COMMAND_SENT = 9;

    public boolean bikeIsConnected;
    public boolean trafficLightIsConnected;

    IntentFilter filter;

    public final String SMARTRIDE_BLUETOOTH_ADDRESS = "00:66:66:6E:DC:85";
    public final String PHONE_BLUETOOTH_ADDRESS = "5C:51:81:BC:11:B6";

    // Bluetooth is set up as a service which allows it to run in the background across multiple activities
    public final IBinder bluetoothBinder = new BluetoothMyLocalBinder();
    ...
    public void getPairedDevices() {
        ...
        if (devicesArray.size() > 0) {
            for (BluetoothDevice device : devicesArray) {
                ...
                device_intent.setAction("ie.ucd.smartride");
...
//    }
    ...
    public final BroadcastReceiver receiver = new BroadcastReceiver() {
        public static final String BROADCAST_ACTION = "ie.ucd.smartride.displayevent";
        @Override
...
//                }
    ...
    public class BluetoothBikeConnectThread extends Thread {
        ...
        public boolean rejectedDevice = false;
    ...
    public class SmartRideConnectedThread extends Thread {
        ...
        public void write(byte[] bytes) {
            ...
            mHandler.obtainMessage(COMMAND_SENT, commandSent).sendToTarget();
        }
        ...
        public boolean handleMessage(Message msg){
            ...
            switch (msg.what) {
                ...
                case PROCESSING_DATA:
                    ...
                    database_intent.setAction("ie.ucd.smartride.database");
                ...
                case TRAFFIC_LIGHT_DATA:
                    ...
                    tlDatabaseIntent.setAction("ie.ucd.smartride.database");
                ...
                case SEND_HR_DATA:
                    ...
                    hr_intent.setAction("info.shaunsweeney.smartride.heartrate");
                    sendBroadcast(hr_intent);
                    break;
                case COMMAND_SENT:
                    String commandSent = (String) msg.obj;
                    Intent cs_intent = new Intent();
                    cs_intent.addFlags(Intent.FLAG_INCLUDE_STOPPED_PACKAGES);
                    cs_intent.putExtra("commandSent", commandSent);
                    cs_intent.setAction("ie.ucd.smartride.commandSent");
                    sendBroadcast(cs_intent);
                    break;
